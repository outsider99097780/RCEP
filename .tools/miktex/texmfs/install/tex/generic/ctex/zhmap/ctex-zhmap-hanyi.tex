%%
%% This is file `ctex-zhmap-hanyi.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% ctex-fontset.dtx  (with options: `zhmap,hanyi')
%% -----------------------------------------------------------------------
...
\GetIdInfo $Id: ctex-fontset.dtx 2.6.5 2026-08-11 16:50:29 +0800 79898321 Liam <liamhuang0205@gmail.com>$
  {Hanyi font map loader for pdfTeX and DVIPDFMx (CTEX)}%
...
\fi
\endgroup
\ProvidesFile{ctex-zhmap-hanyi.tex}%
...
%% 
%%
%% End of file `ctex-zhmap-hanyi.tex'.
