...
%%
%% ctex-fontset.dtx  (with options: `zhmap,mac')
%% -----------------------------------------------------------------------
...
%% -----------------------------------------------------------------------
\def \GetIdInfo $Id: #1.#2 #3 #4-#5-#6 #7$ #8{%
  \edef \ExplFileDate       {#4/#5/#6}%
  \edef \ExplFileVersion    {#3}%
...
\GetIdInfo $Id: ctex-fontset.dtx 2.6.5 2026-08-11 16:50:29 +0800 79898321 Liam <liamhuang0205@gmail.com>$
  {Mac font map loader for DVIPDFMx (CTEX)}%
...
\else
  \special{pdf:mapline gbk@UGBK@          UniGB-UTF16-H :6:Songti.ttc}
  \special{pdf:mapline gbksong@UGBK@      UniGB-UTF16-H :6:Songti.ttc}
  ...
  \special{pdf:mapline cyberb@Unicode@    UniGB-UTF16-H :6:Songti.ttc}
  \special{pdf:mapline unisong@Unicode@   UniGB-UTF16-H :6:Songti.ttc}
  ...
  \special{pdf:mapline gbksongsl@UGBK@    UniGB-UTF16-H :6:Songti.ttc   -s .167}
  ...
  \special{pdf:mapline unisongsl@Unicode@ UniGB-UTF16-H :6:Songti.ttc   -s .167}
