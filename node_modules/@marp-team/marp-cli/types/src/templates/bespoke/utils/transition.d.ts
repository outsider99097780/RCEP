...
declare const testElementAnimation: (elm: HTMLElement, callback: (ret: MarpTransitionResolvableKeyframeSettings | undefined) => void) => void;
export declare const _helpers: {
    testElementAnimation: typeof testElementAnimation;
};
declare const types: {
    readonly both: '';
